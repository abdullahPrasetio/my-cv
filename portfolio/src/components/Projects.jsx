...
const ProjectCard = ({ project, index, lang, t }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 overflow-hidden hover:shadow-xl hover:shadow-primary/5 transition-all duration-300"
    >
      ...
      <div className="p-8">
        <div className="flex justify-between items-start mb-6">
          ...
          <ExternalLink size={20} className="text-slate-400 group-hover:text-primary transition-colors cursor-pointer" />
        </div>
