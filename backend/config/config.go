...
type R2Config struct {
	AccountID string `mapstructure:"account_id"` // CF_R2_ACCOUNT_ID
	AccessKey string `mapstructure:"access_key"` // CF_R2_ACCESS_KEY
	SecretKey string `mapstructure:"secret_key"` // CF_R2_SECRET_KEY
	Bucket    string `mapstructure:"bucket"`     // CF_R2_BUCKET
	PublicURL string `mapstructure:"public_url"` // CF_R2_PUBLIC_URL
}
...
func Load() (*Config, error) {
	...
	bindings := map[string]string{
		...
		"r2.account_id":                 "CF_R2_ACCOUNT_ID",
		"r2.access_key":                 "CF_R2_ACCESS_KEY",
		"r2.secret_key":                 "CF_R2_SECRET_KEY",
		"r2.bucket":                     "CF_R2_BUCKET",
		"r2.public_url":                 "CF_R2_PUBLIC_URL",
